      ...
      <div className="form-group genre">
        ...
        <div className='form-genre'>
            ...
            <div className="button-container">
              <a href="/Type"><button type="button" onClick={prevStep} className='btnR'>Revenir</button></a>
              <a href="/Coordonnees"><button type="submit" onClick={nextStep} disabled={!isValid} className='btnS'>Suivant</button></a>
            </div>
          </Form> </Fragment>
        )}
      </Formik>
